/**
 * Created by keziyuan on 2016/1/13.
 */
(function (root, factory) {
    ...
    angular.module('ghiscoding.validation')
        .factory('validationCommon', ['$rootScope', '$timeout', '$translate', 'validationRules',
            function ($rootScope, $timeout, $translate, validationRules) {
                ...
                for (var i = 0, ln = obj.$validationSummary.length; i < ln; i++) {
                    ...
                    if (!!elmName) {
                        ...
                        if (!!formElmObj && !!formElmObj.elm && formElmObj.elm.length > 0) {
                            ...
                            self.commonObj.updateErrorMsg(obj.$validationSummary[i].message, {
                                isSubmitted: true,
                                isValid: formElmObj.isValid,
                                obj: formElmObj
                            });
                        }
                    }
